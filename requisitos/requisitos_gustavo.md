...
- Provedor utilizado (PostgreSQL, MySQL, SQL Server, MongoDB, Redis, DynamoDB etc.).
...
| --- | --- | --- |
| cpf | B-Tree | Busca por CPF |
| data_pedido | B-Tree | Filtros por período |
...
Durante a apresentação e avaliação do projeto, poderão ser realizadas perguntas individuais aos integrantes do grupo. As notas poderão ser atribuídas de forma individual, de acordo com o nível de participação, conhecimento demonstrado e contribuição de cada aluno para o desenvolvimento do trabalho.
